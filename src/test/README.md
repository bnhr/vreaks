...
This directory contains reusable test utilities for the testing infrastructure.
...
test('mocking API responses', async () => {
	...
	await mockApiResponse(queryClient, ['users', '123'], {
		id: '123',
		name: 'John',
	})
...
See `state-utils.example.test.ts` for comprehensive examples of all utilities.
